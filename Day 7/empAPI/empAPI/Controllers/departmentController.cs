...
namespace empAPI.Controllers
{
    ...
    {
        private readonly EmpDetailDbContext _context = new EmpDetailDbContext();

        //public departmentController(EmpDetailDbContext context)
        //{
        //    _context = context;
        //}
        ...
        public async Task<ActionResult<DeptInfo>> PostDeptInfo(DeptInfo deptInfo)
        {
          if (_context.DeptInfos == null)
          {
              return Problem("Entity set 'EmpDetailDbContext.DeptInfos'  is null.");
          }
